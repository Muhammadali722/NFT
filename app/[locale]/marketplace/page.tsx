...
const Marketplace = () => {
  return (
    <div className='containers  justify-center mx-auto !pt-[80px] !mb-[80px]'>
      <Heading tag='h2' classList='justify-center'>Browse Marketplace</Heading>
      <Text classList='!text-[22px] !mb-[30px] justify-center'>Browse through more than 50k NFTs on the NFT Marketplace.</Text>
